...
function validateDateOfBirth(){
  const yearOfBirth = Number(moment(dateOfBirth.value).format('YYYY')); // Number(dateOfBirth.value.split('/')[2]);
  const currentYear = Number(moment().format('YYYY')); // new Date().getFullYear()
